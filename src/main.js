...
import Vue from 'vue'
import App from './App' // 导入App组件，总组件，就是该组件显示页面上。
...
// 可以在base中导入其它的router，base中定义了一个数组用来存放。
// 将base/router中的router数组导入。该对象就代表了所有router。
const router = new VueRouter({
  routes:routes // 该对象就是有个属性routes，值为数组形式，定义多个route。
});
/*
